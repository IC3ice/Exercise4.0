class Tree<T>
{
    ...
    public Queue<T> ShowUpper(T value){
        TreeNode<T> showupper = GetTreeNode(value);
        Queue<T> queueshowupper = new Queue<T>();

        while(true){
            T nani = showupper.Upper().GetValue();
            queueshowupper.Push(nani);
            showupper = showupper.Upper();
            if(showupper.Upper() == null ){
                break;
            }
        }
        return queueshowupper;
    }
